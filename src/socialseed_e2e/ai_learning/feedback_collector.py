...
class FeedbackCollector:
    ...
    def analyze_patterns(self) -> Dict[str, Any]:
        ...
        execution_times = [f.execution_time for f in self._feedback_cache if f.execution_time is not None]
        ...
        for feedback in self._feedback_cache:
            if feedback.error_message:
                error_counts[feedback.error_message] = error_counts.get(feedback.error_message, 0) + 1
