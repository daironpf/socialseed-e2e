...
class TestE2ERunCommand:
    ...
    def test_run_shows_configuration(
        self, isolated_cli_runner, temp_dir, mock_api_server
    ):
    ...
    def test_run_shows_environment(
        self, isolated_cli_runner, temp_dir, mock_api_server
    ):
    ...
    def test_run_shows_services_table(
        self, isolated_cli_runner, temp_dir, mock_api_server
    ):
    ...
    def test_run_with_service_filter(
        self, isolated_cli_runner, temp_dir, mock_api_server
    ):
