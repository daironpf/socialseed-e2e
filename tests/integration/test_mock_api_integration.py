...
class TestMockAPIUsersCRUD:
    ...
    def test_update_user(self, mock_api_url):
        ...
        response = requests.put(f"{mock_api_url}/api/users/{user_id}", json=update_data)
    ...
    def test_delete_user(self, mock_api_url, mock_api_reset):
        ...
        create_response = requests.post(f"{mock_api_url}/api/users", json=new_user)
...
class TestMockAPIAuthentication:
    ...
    def test_register_new_user(self, mock_api_url, mock_api_reset):
        ...
        response = requests.post(f"{mock_api_url}/api/auth/register", json=new_user)
